...
<head>
    ...
    <link href="{{url('css/font-awesome.html')}}" rel="stylesheet">
    <link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css">
    {{--social icons--}}
    <link href="{{('//maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css')}}" rel="stylesheet">
    <!-- <link href="{{'//maxcdn.bootstrapcdn.com/font-awesome/4.1.0/css/font-awesome.min.css)'}}" rel="stylesheet"> -->
    <link href="{{('css/bootstrap.min.css')}}s" rel="stylesheet" integrity="sha256-MfvZlkHCEqatNoGiOXveE8FIwMzZg4W85qfrfIFBfYc= sha512-dTfge/zgoMYpP7QbHy4gWMEGsbsdZeCXz7irItjcC3sPUFtf0kuFbDz/ixG7ArTxmDjLXDmezHubeNikyKGVyQ==" crossorigin="anonymous">
    <!-- // -->
    <!--//theme-style-->
    ...
    <meta name="keywords" content="Yabba Hostels Management System" />
                ...
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <div class="navbar-brand logo">
                            <h1> <span style="padding:30px 0;">
                                <a href="{{url('/')}}"><img src="{{url('images/logo.png' )}}" class="grayl" alt="logo" />
                                </a></span></h1>
                            {{--<label style="float:right"><a href="{{url('/logout')}}">Log out</a> </label>--}}
                            {{--<label style="float:right"><span style="color#000;">Welcome,</span><a href=""></a> </label>--}}
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="{{url('/about')}}" data-hover="About">About Us</a></li>
                            <li><a data-hover="Hostels" href="{{url('/hostels')}}">Hostels</a></li>
                            <li><a data-hover="Contact" href="{{url('/contact')}}">Contact</a></li>

                            @if(\Illuminate\Support\Facades\Auth::check())
                            <li><a data-hover="Logout" href="{{url('/logout')}}">Logout</a></li>
                                <li><a data-hover="Logout" href="{{url('/checkout')}}">CheckOut</a></li>
                                @else
...
<div class="copy-section">
    <div class="container">
        <div class="footer-top">
            <p>&copy; 2017 Yabba Hostels Management System. All rights reserved | Design by Lawrence Kamau</p>
        </div>
      <!--   <div class="col-md-12"> -->
